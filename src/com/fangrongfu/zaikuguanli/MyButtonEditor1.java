 ...
 *
 */
public class MyButtonEditor1 extends DefaultCellEditor
{
    ...
    public MyButtonEditor1(String id,String num,JTable table,String Str,Vector tableValues)
    {
    ...
    private void initButton(String id,String num,JTable table,String Str,Vector tablevalues)
    {
        ...
        this.button.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e)
            {
                ...
                MyButtonEditor1.this.fireEditingCanceled();
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        try {
                            ...
                            QuehuoFrame1 quehuof=new QuehuoFrame1(id,num,table,Str,tablevalues);
