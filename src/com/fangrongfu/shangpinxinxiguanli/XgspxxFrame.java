...
public class XgspxxFrame extends JFrame{
	...
	public XgspxxFrame() {
		...
		querenButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Dao.xgspxx(idStr,nameStr);//函数功能：增加商品信息
					JOptionPane.showMessageDialog(XgspxxFrame.this, "查找商品信息成功","提示", JOptionPane.INFORMATION_MESSAGE);
					//}
				}catch(Exception e1) {
					e1.printStackTrace();
				}
		...
		quxiaoButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int result=JOptionPane.showConfirmDialog(XgspxxFrame.this, "是否确认退出？", "提示", JOptionPane.YES_NO_OPTION);
				if(result==JOptionPane.YES_OPTION) {
					XgspxxFrame.this.dispose();
				}
				else if(result==JOptionPane.NO_OPTION){
					XgspxxFrame.this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
				}
			}
