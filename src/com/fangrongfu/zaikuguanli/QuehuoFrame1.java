...
public class QuehuoFrame1 extends JFrame{

	JLabel numberLabel;//“购货数量”标签

	JTextField numberField;//“购货数量”文本框
	...
	public QuehuoFrame1(String id,String num,JTable table,String Str,Vector tableValues) {

		numberLabel=new JLabel("购货数量");//“购货数量”标签
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(isNumeric(tianjiaNum)==true) {
						...
						JOptionPane.showMessageDialog(QuehuoFrame1.this, "已成功添加该商品到缺货单","提示", JOptionPane.INFORMATION_MESSAGE);
						setVisible(false);
					}else {
						JOptionPane.showMessageDialog(QuehuoFrame1.this,"输入的不是数字，请输入数字","错误",JOptionPane.ERROR_MESSAGE);
					}
