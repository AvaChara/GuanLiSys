...
public class QuehuoFrame extends JFrame{
	...
	public static String lackid;//全局变量，缺货单号
	...
	public QuehuoFrame() {
					...
					querenButton.addActionListener(new ActionListener() {
						...
						public void actionPerformed(ActionEvent e) {
							...
							try {
								...
								jhdTable.getColumnModel().getColumn(9).setCellRenderer(new MyButtonRender1());//只有获取到表格的列后才能添加渲染器。
								...
								selectionModel.addListSelectionListener(new ListSelectionListener() {
									...
									public void valueChanged(ListSelectionEvent e) {
										...
										jhdTable.getColumnModel().getColumn(9).setCellEditor(new MyButtonEditor1(id,num,jhdTable,Str,tableValues));//修改表格的默认编辑器
								...
								JOptionPane.showMessageDialog(QuehuoFrame.this, "查询商品信息成功","提示", JOptionPane.INFORMATION_MESSAGE);
								//}
		...
		quxiaoButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int result=JOptionPane.showConfirmDialog(QuehuoFrame.this, "是否确认退出？", "提示", JOptionPane.YES_NO_OPTION);
				if(result==JOptionPane.YES_OPTION) {
					QuehuoFrame.this.dispose();
				}
				else if(result==JOptionPane.NO_OPTION){
					QuehuoFrame.this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
				}
			}
		...
		wanchengButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(QuehuoFrame.this, "生成缺货单成功","提示", JOptionPane.INFORMATION_MESSAGE);

				//此时自动生成一个出货单号
				Random rand = new Random();
				lackid=CreateId.test(rand.nextInt(9999));

				//编写用于打开出货单窗口的代码
				QuehuodanFrame quehuodanf=new QuehuodanFrame(tableValues,lackid);
				quehuodanf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				quehuodanf.setVisible(true);
