...
public class MyButtonEditor extends DefaultCellEditor
{
    ...
    public MyButtonEditor(String id,String num,JTable table,String Str,Vector tableValues)
    {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        ...
                        try {
                            ...
                            ChuhuoFrame1 chuhuof=new ChuhuoFrame1(id,num,table,Str,tablevalues);
